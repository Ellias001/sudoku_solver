...
class Board:
    ...
    def __init__(self, master, generator, cube_size = 50, mistakes_limit = 5):
        self.master = master
        self.generator = generator
        self.generator.generate()
        self.unsolved_board = generator.get_unsolved()
        self.solved_board = generator.get_solved()
